...
//		// ファイルを開く
//		FILE* fp = nullptr;
//		fopen_s(&fp, "Shader\\BasicVS.cso", "rb");
...
//		// ファイルを開く
//		FILE* fp = nullptr;
//		fopen_s(&fp, "Shader\\BasicPS.cso", "rb");
//		_ASSERT_EXPR_A(fp, "CSO File not found");
//
//		// ファイルのサイズを求める
//		fseek(fp, 0, SEEK_END);
...
//
//// 描画開始
//void BasicShader::Begin(ID3D11DeviceContext* dc, const RenderContext& rc)
//{
...
//
//// 描画
//void BasicShader::Draw(ID3D11DeviceContext* dc, const Model* model)
//{
...
//
//// 描画終了
//void BasicShader::End(ID3D11DeviceContext* dc)
//{
